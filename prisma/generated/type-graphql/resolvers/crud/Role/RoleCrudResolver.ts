...
export class RoleCrudResolver {
  ...
  async findFirstRoleOrThrow(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: FindFirstRoleOrThrowArgs): Promise<Role | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async getRole(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: FindUniqueRoleOrThrowArgs): Promise<Role | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
